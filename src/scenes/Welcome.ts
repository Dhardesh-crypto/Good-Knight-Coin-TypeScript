...
const MORALIS_POWERED = 'PoweredByMoralis';

export default class Scene1 extends Phaser.Scene {
    private background! : Phaser.GameObjects.Image;
    private poweredByMoralis! : Phaser.GameObjects.Image;
    ...
    preload() {
        ...
        this.load.image(MORALIS_POWERED, 'assets/Powered-by-Moralis-Badge-Green.png');
    }
